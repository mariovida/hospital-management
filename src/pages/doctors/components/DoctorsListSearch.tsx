...
interface DoctorsListSearchProps {
...
export const DoctorsListSearch: React.FC<DoctorsListSearchProps> = (props) => {
  ...
  return (
    <>
      <Stack alignItems="center" direction="row" flexWrap="wrap" spacing={3}>
        ...
        {role === "admin" ? (
          <SearchButton onClick={addNewDoctor}>Add new</SearchButton>
        ) : (
          <></>
        )}
      </Stack>
